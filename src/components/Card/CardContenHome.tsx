...
import { DataContentHome } from "@/utils/DataContent";
import Link from "next/link";
export default function CardContentHome() {
	return (
		<div className=" mt-12 px-[10vw]">
			<div className="grid grid-cols-3 gap-x-12  tablet:grid-cols-2 mobile:block">
				{DataContentHome.map((data, index) => {
					return (
						<div key={index} className="">
							...
							<div className="absolute -mt-[150px]  ml-[259px] text-white bg-[#3d7d7b]/80 px-3 py-1 rounded-full tablet:-mt-[122px] tablet:ml-[193px] mobile:-mt-[122px] mobile:ml-[197px]">
