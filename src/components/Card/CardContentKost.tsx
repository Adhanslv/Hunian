					...
					return (
						<div key={index} className="">
							<Link href="/Preview/[kostid]" as={`/Preview/${data.kostid}`}>
								...
								<div className="object-cover absolute -mt-[150px]  ml-[259px] text-white bg-[#3d7d7b]/80 px-3 py-1 rounded-full tablet:-mt-[122px] tablet:ml-[193px] mobile:-mt-[122px] mobile:ml-[197px]">
